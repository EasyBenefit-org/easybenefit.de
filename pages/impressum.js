        ...
        <>
            ...
            <Container>
                <PageHeaderTextCenterSimple
                    Heading="Impressum"
                    SubHeading="Gemäß §5 TMG"
                />
                <p>
                    EasyBenefit gemeinnützige UG (haftungsbeschränkt)<br/>
                    Pilgerhausstraße 19<br/>
                    86152 Ausgburg
                </p>
                <p>
                    E-Mail: info(at)easybenefit.de
                </p>
                <p>
                    Amtsgericht Mannheim<br/>
                    HRB 725585<br/>
                    USt-ID: DE307699159<br/>
                    Geschäftsführer: Philipp Jawny
                </p>
                <p>
                    Dieses Impressum gilt sowohl für die Webseite, als auch die offiziellen Social Media Profile der EasyBenefit gUG (haftungsbeschränkt).
                </p>
